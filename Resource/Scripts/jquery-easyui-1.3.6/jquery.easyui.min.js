...
(function($) {
	...
	function _1c7(_1cb) {
		...
		switch (opts.position) {
			...
			case "bottom":
			    ...
			    top += (t._outerHeight() + 12 + (opts.trackMouse ? 12 : 0))-15;
			   // console.log(top)
				break;
		}
		if (!$(_1cb).is(":visible")) {
	...
	$.fn.tooltip.defaults = {
		position: "top",//修改默认显示位置bottom=========================================马贞晓
		content: null,
		trackMouse: false,
		deltaX: 0,
		deltaY: 0,
...
(function($) {
	...
	function show(_4ae) {
		...
		$(_4ae).find(".calendar-title span").html(opts.months[opts.month - 1] + " " + opts.year + "年");
...
(function($) {
	function _83e(_83f, _840) {
		...
		_842._outerWidth(opts.width)._outerHeight();
		_842.css("height", "24px");
		...
		_845._outerHeight(Math.max(_842.height(), 24));
	...
	function init(_847) {
		...
		$(_847).addClass("combo-f")
		       .addClass("combo-mazhenxiao")
		//console.log(_847)
		var span = $("<span class=\"combo combo-error\">" + "<input type=\"text\"  class=\"combo-text\" autocomplete=\"off\">" + "<span><span class=\"combo-arrow\"></span></span>" + "<input type=\"text\" class=\"combo-value\">" + "</span>").insertAfter(_847);
		...
		_848.panel({
			...
			onOpen: function() {
				...
				if ($(this).find(".datebox-calendar-inner").length) {

					var
						ch = document.body.scrollHeight,
						h = document.body.offsetHeight,
						t = p.css("top"),
						v = parseInt(t) + p.outerHeight(),
						ifr = window.top.document.getElementsByTagName("iframe"),
						_h = 1000000;
					window.name = "_self_";
					for (var i = 0; i < ifr.length; i++) {
						var nav = ifr[i].contentWindow.name;
						if (nav == "_self_") {
							ifr = ifr[i];
							_h = $(ifr).outerHeight();
							// console.log(_h);
					...
					if (v > _h) {
						if (ifr.scrolling == "yes" || ifr.scrolling == "auto") {
							ifr.scrolling = "no";
						    /*===============================================================================马贞晓修改过注释原因为造成弹出窗口不能出现滚动条
                            ifr.parentNode.style.overflow = "hidden";
						...
						setTimeout(function() {
							var x = v - _h;
							//p.css("margin-top", -(x + 20) + "px");======= 因为异常所以注视了2015/4/21
							// console.log(x);
						})
						// p.css("top", parseInt(p.css("top")) - (_th - h) + "px");
					}
		...
		if (name) {
           ...
           // console.log(_847);
			//span.find("input.combo-value").attr("vname", name);
			//$(_847).attr("comboName", name);
	...
	function _881(_882, _883) { 
		...
		for (var i = 0; i < _883.length; i++) {
			...
			var mazhenxiao = $(_885).parent().find(".combo-mazhenxiao");
			if (name) {
				//_886.attr("name", name);
				 
				_886.attr("mod-name", name);
			}
           
            mazhenxiao.val(_883[i]).blur();

			_886.val(_883[i]); //给隐藏内容负值
		}
		var tmp = [];
...
(function($) {
	...
	$.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		buttons: [{
		    ...
		    text: function (_ma01) {
		        return $(_ma01).datebox("options").clear;
		    },
		    handler: function (_ma02) {
		        var $_ma02_01 = $(this),
                    $opts = $.data(_ma02, "datebox");
		        //_ma02.value = "";
		        $(_ma02).combo("setValue", "").combo("setText","");
		        //console.log(_934);
		        //console.log($_ma02_01);
		        //console.log(_ma02)
		        //console.log($opts);
		        // _935(_ma02);

		        $_ma02_01.closest("div.combo-panel").panel("close");
		    }
		}],
		formatter: function(date) {
