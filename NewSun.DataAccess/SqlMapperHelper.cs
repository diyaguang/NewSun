...
namespace Com.NewSun.DataAccess
{
    public static class SqlMapperHelper
    {
        ...
        /// <returns></returns>
        public static bool Insert<T>(this DbBase dbs, T t, IDbTransaction transaction = null, int? commandTimeout = null) where T : BaseModel, new()
        {
            BuildBaseModelInfo(t);
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public static bool InsertBatch<T>(this DbBase dbs, IList<T> lt, IDbTransaction transaction = null, int? commandTimeout = null) where T : BaseModel, new()
        {
            foreach(T t in lt)
                BuildBaseModelInfo(t);
            var db = dbs.DbConnecttion;
        ...
        /// <returns></returns>
        public static bool Delete<T>(this DbBase dbs, SqlQuery sql = null) where T : BaseModel, new()
        {
            var db = dbs.DbConnecttion;
            if (sql == null)
            {
        ...
        /// <returns></returns>
        public static bool Update<T>(this DbBase dbs, T t, SqlQuery sql = null) where T : BaseModel, new()
        {
            BuildBaseModelInfo(t);
            var db = dbs.DbConnecttion;
            if (sql == null)
        ...
        /// <param name="sql">按条件修改</param>
        /// <returns></returns>
        public static bool Update<T>(this DbBase dbs, T t, IList<string> updateProperties, SqlQuery sql = null) where T : BaseModel, new()
        {
            BuildBaseModelInfo(t);
            var db = dbs.DbConnecttion;
            if (sql == null)
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        public static T SingleOrDefault<T>(this DbBase dbs, SqlQuery sql) where T : BaseModel, new()
        {
            var db = dbs.DbConnecttion;
            if (sql == null)
            {
        ...
        /// <returns></returns>
        public static IList<T> Page<T>(this DbBase dbs, int pageIndex, int pageSize, out long dataCount, SqlQuery sqlQuery = null) where T : BaseModel, new()
        {
            var db = dbs.DbConnecttion;
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        public static IList<T> Query<T>(this DbBase dbs, SqlQuery sql = null) where T : BaseModel, new()
        {
            var db = dbs.DbConnecttion;
            if (sql == null)
            {
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        public static long Count<T>(this DbBase dbs, SqlQuery sql = null) where T : BaseModel, new()
        {
            var db = dbs.DbConnecttion;
            if (sql == null)
            {
